...
import { SelectionListProduct } from "@/contexts/ProductManageContext";

interface InputSelectionProductProps {
  titleInput: string;
  options: SelectionListProduct[]; // Options for selection
  width: string;
  value?: string | null; // Current value selected
  onChange?: (value: string) => void; // Callback for handling value change
}

const InputSelectionProduct: React.FC<InputSelectionProductProps> = ({
  titleInput,
  options,
  width,
  value,
...
export default InputSelectionProduct;
